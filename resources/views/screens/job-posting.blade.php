                ...
                <div class="col-lg-9">
                    <div class="commonDiv">
                        ...
                        <form action="{{route('post-a-job')}}" method="post">
                           ...
                           <div class="inputDiv">
                            <label for="">Expiry Date <span class="required">*</span></label>
                            <input class="form-control" type="date" name="job_expirydate" id="job_expirydate" placeholder="Expiry Date" required="required">
                           </div>
                           <div class="languageDiv">
                               ...
                               <p>Please include both language pairs if you need an interpreter. For example, if you need an English-French interpreter, select English>French 
                                ...
                                <div class="multiple-select">
                                    <div class="row">
                                        <div class="col-md-4">
                                        <select   class="form-control" id="from_language" name="from_language[]" required="required">
                                        ...
                                        <div class="col-md-4">
                                        <select   class="form-control" id="to_language" name="to_language[]" required="required">
                                            <option value="">Select Language</option>
                                            <option value="af">Afrikaans</option>
                                            <option value="sq">Albanian - shqip</option>
                                            <option value="am">Amharic - አማርኛ</option>
                                ...
                                <br>
                                 <button type="button" class="btn btn-danger addpair mx-0">Add More <span class="fa fa-plus"></span></button>
                           </div>
...
<script type="text/javascript">
    $(".addpair").click(function(){
       $(".multiple-select").append($("#pairlngdev").html());
    })
