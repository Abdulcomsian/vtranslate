        ...
        <div class="row">
            <div class="col-md-12">
                <div class="progressBar">
                    <h4>Profile Strength ({{auth::user()->mark_profile_section/auth::user()->total_profile_section*100}}%)</h4>
                    <div class="progressBarcontainer">
                        <div class="speech-bubble html">{{auth::user()->mark_profile_section/auth::user()->total_profile_section*100}}%</div>
...
<script>
    ...
    skillbar.animate({
            width: '{{auth::user()->mark_profile_section/auth::user()->total_profile_section*100}}' + "%"
        },
        3000,
        function() {
